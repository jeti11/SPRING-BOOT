...
public class User implements UserDetails {
  ...
  private String email; // email을 로그인용 id로 사용함
  ...
  // 상속받은 UserDetails 인터페이스의 메소드 구현
  ...
  // getPassword() 도 있지만, 현재 클래스의 필드에 password가 존재하고 롬복의 @Getter 어노테이션을 통해서 자동으로 getPassword()가 생성되어 오버라이딩 부분이 빠져있음
